...
describe("Basics Utils", () => {
  ...
  describe("getSiteManifest", () => {
    it("should return the site manifest", () => {
  ...
  describe("loadPage", () => {
    ...
    it("should load a page with front matter and markdown", async () => {
      const mockMarkdown = `---
title_h1: "Test Title"
...
This is a test.`;
    ...
    it("should handle missing jumbo", async () => {
      const mockMarkdown = `---
title_h1: "No Jumbo"
---
Content`;
