...
<div class="container mx-auto p-8 space-y-16">
    ...
    <div class="prose prose-lg max-w-none mb-12">
      <p>
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer">Tailwind CSS colour system</a
        >. The main neutral colour is <strong>Slate</strong>, which has been
        modified to have a richer, bluer hue and is used for backgrounds and
        text.
      </p>
      <p>
        The primary accent colour is <strong>Blue</strong>, used for links,
        buttons, and highlighting active elements. <strong>Orange</strong>
        serves as a secondary accent for filters and notifications.
        <strong>Red</strong>
        is reserved for destructive actions and error states. All customisations can
        be found in <code>src/app.css</code>.
      </p>
    </div>
  ...
  <section>
    ...
    <div class="prose prose-lg max-w-none mb-12">
      <p>
        This section is not using the <code>@tailwindcss/typography</code> plugin
        to ensure the raw heading styles are displayed without prose styling.
      </p>
    </div>
    <div class="space-y-6">
      <h1 class="text-5xl font-bold">Heading H1</h1>
      <h2 class="text-4xl font-bold">Heading H2</h2>
      <h3 class="text-3xl font-bold">Heading H3</h3>
      <h4 class="text-2xl font-semibold">Heading H4</h4>
      <h5 class="text-xl font-semibold">Heading H5</h5>
      <h6 class="text-lg font-semibold">Heading H6</h6>
    </div>

    <div class="mt-12">
      <h3 class="text-2xl font-medium mb-4">Font Stacks</h3>
      <p class="text-gray-700">
        The project currently uses the default Tailwind CSS font stacks, as no
        custom fonts are defined in either <code>tailwind.config.ts</code> or
      ...
      <ul class="list-disc list-inside mt-4 space-y-2">
        <li>
          ...
          <code class="text-xs"
            ...
            'Arial', "Noto Sans", 'sans-serif', "Apple Color Emoji", "Segoe UI
            Emoji", "Segoe UI Symbol", "Noto Color Emoji"</code
          >
        </li>
        <li>
        ...
        <li>
          ...
          <code class="text-xs"
            ...
            "Liberation Mono", "Courier New", 'monospace'</code
          >
        </li>
      </ul>
    </div>
  ...
  <section>
    ...
    <p class="text-gray-600 mb-8">
      A visual demonstration of the default spacing and sizing scale (e.g., for
      padding, margin, width, and height) in Tailwind CSS. The values are in rem
      (1rem = 16px).
    </p>
